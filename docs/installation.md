...
```sh
sh install-mdtheme.sh --version 0.3.0 --bin-dir "$HOME/.local/bin"
```
...
```sh
cargo install --git https://github.com/sebastian-software/mdtheme --tag mdtheme-v0.3.0 --locked
```
